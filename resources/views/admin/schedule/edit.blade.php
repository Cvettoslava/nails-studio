      ...
      <div class="field-group">
        ...
        <div class="btn-group btn-group-toggle" data-toggle="buttons">
          <label class="btn btn-primary">
            <input value="Basic Polish" type="radio" name="service" id="option1" autocomplete="off" @if($session->service == 'Basic Polish') checked @endif> Basic Polish
          </label>
          <label class="btn btn-primary">
            <input value="Shellac" type="radio" name="service" id="option2" autocomplete="off"  @if($session->service == 'Shellac') checked @endif> Shellac
          </label>
          <label class="btn btn-primary active">
            <input value="Acrylic" type="radio" name="service" id="option3" autocomplete="off"  @if($session->service == 'Acrylic') checked @endif> Acrylic
          </label>
        </div>
      </div>
      <div class="field-group">
